	...
	$lookups = [
		...
		'Donations' => [
			'CatalogID' => [
				...
				'parent_pk_field' => 'ID',
				'parent_caption' => 'IF(CHAR_LENGTH(`Catalog`.`CatalogNo`) || CHAR_LENGTH(`Catalog`.`CatalogTitle`), CONCAT_WS(\'\', `Catalog`.`CatalogNo`, \' - \', `Catalog`.`CatalogTitle`), \'\')',
			...
			'ContactID' => [
				...
				'parent_pk_field' => 'ID',
				'parent_caption' => '`Contacts`.`MailingNameFull`',
				'parent_from' => '`Contacts` ',
				'filterers' => [],
				'custom_query' => '',
				'inherit_permissions' => false,
				'list_type' => 0,
		...
		'Catalog' => [
			'TypeID' => [
				'parent_table' => 'CatalogTypes',
				'parent_pk_field' => 'ID',
				'parent_caption' => '`CatalogTypes`.`TypeName`',
				'parent_from' => '`CatalogTypes` ',
				'filterers' => [],
				'custom_query' => '',
				'inherit_permissions' => false,
				'list_type' => 0,
			...
			'GroupID' => [
				'parent_table' => 'CatalogGroups',
				'parent_pk_field' => 'ID',
				'parent_caption' => '`CatalogGroups`.`GroupName`',
				'parent_from' => '`CatalogGroups` ',
				'filterers' => [],
				'custom_query' => '',
				'inherit_permissions' => false,
				'list_type' => 0,
		...
		'Bidders' => [
			...
			'Business' => [
				'parent_table' => 'Contacts',
				'parent_pk_field' => 'ID',
				'parent_caption' => '`Contacts`.`Business`',
				'parent_from' => '`Contacts` ',
				'filterers' => [],
				'custom_query' => '',
				'inherit_permissions' => false,
			...
			'Address1' => [
				'parent_table' => 'Contacts',
				'parent_pk_field' => 'ID',
				'parent_caption' => '`Contacts`.`Address1`',
				'parent_from' => '`Contacts` ',
				'filterers' => [],
				'custom_query' => '',
				'inherit_permissions' => false,
			...
			'Address2' => [
				'parent_table' => 'Contacts',
				'parent_pk_field' => 'ID',
				'parent_caption' => '`Contacts`.`Address2`',
				'parent_from' => '`Contacts` ',
				'filterers' => [],
				'custom_query' => '',
				'inherit_permissions' => false,
		...
		'Transactions' => [
			...
			'BidderID' => [
				'parent_table' => 'Bidders',
				'parent_pk_field' => 'ID',
				'parent_caption' => 'IF(CHAR_LENGTH(`Bidders`.`BidNo`) || CHAR_LENGTH(`Bidders`.`ContactID`), CONCAT_WS(\'\', `Bidders`.`BidNo`, \' - \', IF(    CHAR_LENGTH(`Contacts1`.`MailingNameFull`), CONCAT_WS(\'\',   `Contacts1`.`MailingNameFull`), \'\')), \'\')',
				'parent_from' => '`Bidders` LEFT JOIN `Contacts` as Contacts1 ON `Contacts1`.`ID`=`Bidders`.`ContactID` ',
				'filterers' => [],
				'custom_query' => '',
				'inherit_permissions' => false,
				'list_type' => 0,
		...
		'Tickets' => [
			...
			'TablePreference' => [
				'parent_table' => 'Bidders',
				'parent_pk_field' => 'ID',
				'parent_caption' => '`Bidders`.`TablePreference`',
				'parent_from' => '`Bidders` LEFT JOIN `Contacts` as Contacts1 ON `Contacts1`.`ID`=`Bidders`.`ContactID` ',
				'filterers' => [],
				'custom_query' => '',
				'inherit_permissions' => false,
			...
			'TableID' => [
				'parent_table' => 'Tables',
				'parent_pk_field' => 'ID',
				'parent_caption' => 'IF(CHAR_LENGTH(`Tables`.`TableNo`) || CHAR_LENGTH(`Tables`.`TableName`), CONCAT_WS(\'\', `Tables`.`TableNo`, \' - \', `Tables`.`TableName`), \'\')',
				'parent_from' => '`Tables` ',
				'filterers' => [],
				'custom_query' => '',
				'inherit_permissions' => false,
			...
			'TableName' => [
				'parent_table' => 'Tables',
				'parent_pk_field' => 'ID',
				'parent_caption' => '`Tables`.`TableName`',
				'parent_from' => '`Tables` ',
				'filterers' => [],
				'custom_query' => '',
				'inherit_permissions' => false,
