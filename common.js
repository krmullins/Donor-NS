...
function Settings_validateData() {
	...
	if($j('#Logo').val() && !AppGini.checkFileUpload('Logo', 'jpg|jpeg|gif|png|webp', 512000)) {
		AppGini.scrollTo('Logo');
		return false;
	}
...
function Catalog_validateData() {
	$j('.has-error').removeClass('has-error');
	var errors = false;

	return !errors;
}
function Bidders_validateData() {
	$j('.has-error').removeClass('has-error');
	var errors = false;
...
function CatalogTypes_validateData() {
	$j('.has-error').removeClass('has-error');
	var errors = false;

	return !errors;
}
function CatalogGroups_validateData() {
	$j('.has-error').removeClass('has-error');
	var errors = false;

	return !errors;
}
function Tickets_validateData() {
	$j('.has-error').removeClass('has-error');
	var errors = false;
