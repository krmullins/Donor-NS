<?php
	...
	if($thisMD5 != $prevMD5) {
		...
		setupTable(
			'OnlineReg', " 
			CREATE TABLE IF NOT EXISTS `OnlineReg` ( 
				...
				`Zip` VARCHAR(50) NULL,
				`Contry` VARCHAR(50) NULL DEFAULT 'US',
				`PurchaseType` VARCHAR(50) NULL,
				`IndividualDetails` VARCHAR(50) NULL,
				`TableDetails` VARCHAR(50) NULL,
				`Guest1` VARCHAR(50) NULL,
				`Guest1Meal` VARCHAR(50) NULL,
				`Guest2` VARCHAR(50) NULL,
				`Guest2Meal` VARCHAR(50) NULL,
				`Guest3` VARCHAR(50) NULL,
				`Guest3Meal` VARCHAR(50) NULL,
				`id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
				PRIMARY KEY (`id`)
			) CHARSET utf8mb4", [
				"ALTER TABLE `table12` RENAME `OnlineReg`",
				"UPDATE `membership_userrecords` SET `tableName`='OnlineReg' WHERE `tableName`='table12'",
				"UPDATE `membership_userpermissions` SET `tableName`='OnlineReg' WHERE `tableName`='table12'",
				"UPDATE `membership_grouppermissions` SET `tableName`='OnlineReg' WHERE `tableName`='table12'",
				"ALTER TABLE OnlineReg ADD `field1` VARCHAR(40)",
				"ALTER TABLE `OnlineReg` CHANGE `field1` `NameFirst` VARCHAR(50) NULL ",
				"ALTER TABLE OnlineReg ADD `field2` VARCHAR(40)",
				"ALTER TABLE `OnlineReg` CHANGE `field2` `NameLast` VARCHAR(50) NULL ",
				"ALTER TABLE OnlineReg ADD `field3` VARCHAR(40)",
				"ALTER TABLE `OnlineReg` CHANGE `field3` `eMail` VARCHAR(50) NULL ",
				"ALTER TABLE `OnlineReg` CHANGE `eMail` `eMail` VARCHAR(80) NULL ",
				"ALTER TABLE OnlineReg ADD `field4` VARCHAR(40)",
				"ALTER TABLE `OnlineReg` CHANGE `field4` `Phone` VARCHAR(50) NULL ",
				"ALTER TABLE OnlineReg ADD `field5` VARCHAR(40)",
				"ALTER TABLE `OnlineReg` CHANGE `field5` `Address1` VARCHAR(50) NULL ",
				"ALTER TABLE OnlineReg ADD `field6` VARCHAR(40)",
				"ALTER TABLE `OnlineReg` CHANGE `field6` `Address2` VARCHAR(50) NULL ",
				"ALTER TABLE OnlineReg ADD `field7` VARCHAR(40)",
				"ALTER TABLE `OnlineReg` CHANGE `field7` `City` VARCHAR(50) NULL ",
				"ALTER TABLE OnlineReg ADD `field8` VARCHAR(40)",
				"ALTER TABLE `OnlineReg` CHANGE `field8` `State` VARCHAR(50) NULL ",
				"ALTER TABLE OnlineReg ADD `field9` VARCHAR(40)",
				"ALTER TABLE `OnlineReg` CHANGE `field9` `Zip` VARCHAR(50) NULL ",
				"ALTER TABLE OnlineReg ADD `field10` VARCHAR(40)",
				"ALTER TABLE `OnlineReg` DROP `NameLast`",
				"ALTER TABLE `OnlineReg` CHANGE `field10` `Contry` VARCHAR(50) NULL ",
				" ALTER TABLE `OnlineReg` CHANGE `Contry` `Contry` VARCHAR(50) NULL DEFAULT 'US' ",
				"ALTER TABLE OnlineReg ADD `field10` VARCHAR(40)",
				"ALTER TABLE `OnlineReg` CHANGE `field10` `PurchaseType` VARCHAR(50) NULL ",
				"ALTER TABLE OnlineReg ADD `field11` VARCHAR(40)",
				"ALTER TABLE `OnlineReg` CHANGE `field11` `PurchaseDetails` VARCHAR(50) NULL ",
				"ALTER TABLE `OnlineReg` CHANGE `PurchaseDetails` `IndividualDetails` VARCHAR(50) NULL ",
				"ALTER TABLE OnlineReg ADD `field12` VARCHAR(40)",
				"ALTER TABLE `OnlineReg` CHANGE `field12` `TableDetails` VARCHAR(50) NULL ",
				"ALTER TABLE OnlineReg ADD `field13` VARCHAR(40)",
				"ALTER TABLE `OnlineReg` CHANGE `field13` `Guest1` VARCHAR(50) NULL ",
				"ALTER TABLE OnlineReg ADD `field14` VARCHAR(40)",
				"ALTER TABLE `OnlineReg` CHANGE `field14` `Guest1Meal` VARCHAR(50) NULL ",
				"ALTER TABLE `OnlineReg` ADD `Guest1_1` VARCHAR(50) NULL ",
				"ALTER TABLE `OnlineReg` ADD `Guest1Meal_1` VARCHAR(50) NULL ",
				"ALTER TABLE `OnlineReg` ADD `Guest1_1_1` VARCHAR(50) NULL ",
				"ALTER TABLE `OnlineReg` ADD `Guest1Meal_1_1` VARCHAR(50) NULL ",
				"ALTER TABLE `OnlineReg` CHANGE `Guest1_1` `Guest2` VARCHAR(50) NULL ",
				"ALTER TABLE `OnlineReg` CHANGE `Guest1Meal_1` `Guest2Meal` VARCHAR(50) NULL ",
				"ALTER TABLE `OnlineReg` CHANGE `Guest1_1_1` `Guest3` VARCHAR(50) NULL ",
				"ALTER TABLE `OnlineReg` CHANGE `Guest1Meal_1_1` `Guest3Meal` VARCHAR(50) NULL ",
				"ALTER TABLE `OnlineReg` CHANGE `NameFirst` `Name` VARCHAR(50) NULL ",
				"ALTER TABLE OnlineReg ADD `field19` VARCHAR(40)",
				"ALTER TABLE `OnlineReg` CHANGE `field19` `id` VARCHAR(50) NULL ",
				"ALTER TABLE `OnlineReg` CHANGE `id` `id` INT UNSIGNED NOT NULL AUTO_INCREMENT ",
			]
		);
